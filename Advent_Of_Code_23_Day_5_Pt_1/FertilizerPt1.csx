...
for (int i = 0; i < conversions.Count; i++)
{
    ...
    {
        if (conversions[i] >= seedToSoil[j][1] &&
            conversions[i] < (seedToSoil[j][1] + seedToSoil[j][2]))
        {
            conversions[i] = seedToSoil[j][0] + 
                (conversions[i] - seedToSoil[j][1]);
            break;
        }
    }
    ...
    {
        if (conversions[i] >= soilToFertilizer[j][1] &&
            conversions[i] < (soilToFertilizer[j][1] + 
            soilToFertilizer[j][2]))
        {
            conversions[i] = soilToFertilizer[j][0] + 
                (conversions[i] - soilToFertilizer[j][1]);
            break;
        }
    }
    ...
    {
        if (conversions[i] >= fertilizerToWater[j][1] &&
            conversions[i] < (fertilizerToWater[j][1] + 
            fertilizerToWater[j][2]))
        {
            conversions[i] = fertilizerToWater[j][0] + 
                (conversions[i] - fertilizerToWater[j][1]);
            break;
        }
    }
    ...
    {
        if (conversions[i] >= waterToLight[j][1] &&
            conversions[i] < (waterToLight[j][1] + 
            waterToLight[j][2]))
        {
            conversions[i] = waterToLight[j][0] + 
                (conversions[i] - waterToLight[j][1]);
            break;
        }
    }
    ...
    {
        if (conversions[i] >= lightToTemperature[j][1] &&
            conversions[i] < (lightToTemperature[j][1] + 
            lightToTemperature[j][2]))
        {
            conversions[i] = lightToTemperature[j][0] + 
                (conversions[i] - lightToTemperature[j][1]);
            break;
        }
    }
    ...
    {
        if (conversions[i] >= temperatureToHumidity[j][1] &&
            conversions[i] < (temperatureToHumidity[j][1] + 
            temperatureToHumidity[j][2]))
        {
            conversions[i] = temperatureToHumidity[j][0] + 
                (conversions[i] - temperatureToHumidity[j][1]);
            break;
        }
    }
    ...
    {
        if (conversions[i] >= humidityToLocation[j][1] &&
            conversions[i] < (humidityToLocation[j][1] + 
            humidityToLocation[j][2]))
        {
            conversions[i] = humidityToLocation[j][0] + 
                (conversions[i] - humidityToLocation[j][1]);
            break;
        }
    }
}
long lowestLocation = conversions[0];

for (int i = 0; i < conversions.Count; i++)
{
    if (conversions[i] < lowestLocation)
    {
        lowestLocation = conversions[i];
    }
}
